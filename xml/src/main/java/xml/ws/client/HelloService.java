 ...
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws.xml/", wsdlLocation = "http://localhost:1212/hello?wsdl")
public class HelloService extends Service {

    private final static URL HELLOSERVICE_WSDL_LOCATION;
    private final static WebServiceException HELLOSERVICE_EXCEPTION;
    private final static QName HELLOSERVICE_QNAME = new QName("http://ws.xml/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://ws.xml/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.xml/", "HelloPort"), Hello.class, features);
    }
